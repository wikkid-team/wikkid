...
class TestGetWikiFormtter(TestCase):
    ...
    def test_default_missing(self):
        self.assertRaises(KeyError, get_wiki_formatter, "some content", "missing")

    def test_default_exists(self):
        content, formatter = get_wiki_formatter("some content", "rest")
        self.assertEqual("some content", content)
        self.assertEqual("RestructuredTextFormatter", formatter.__class__.__name__)
