...
class TestFactoryGetPreferredPath(FactoryTestCase):
    ...
    def test_default_preferred(self):
        ...
        self.assertEqual("/FrontPage", factory.get_preferred_path("/"))
        self.assertEqual("/FrontPage", factory.get_preferred_path("/FrontPage"))
        self.assertEqual("/FrontPage", factory.get_preferred_path("/FrontPage.txt"))

    def test_image_preferred(self):
        factory = self.make_factory()
        self.assertEqual("/foo/bar.jpg", factory.get_preferred_path("/foo/bar.jpg"))
